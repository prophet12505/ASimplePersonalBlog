...
<html>
  ...
  <body>
    ...
    <article class="aboutcon">
      <h1 class="t_nav"><span>信念和目标促使我努力前进。</span></h1>
      <br />
      <div class="about">
        <h2>About me</h2>
        <br />
        <div id="me_text">
          ...
          <p>
            很多时候觉得自己对待任何事都很执着，一旦定了目标，就会不达目标不罢休，永不退缩！
            面对爱情也是一样，当真正遇到自己喜欢的一个人，会不顾一切去追。
          </p>
          <p>
            ...
            本人好学上进，诚信、敬业、
            责任心强，有强烈的团体精神，对工作认真积极，严谨负责。
          </p>
          <p>
            感谢那些曾经帮助过我的人，因为有你们我才会变得如此的优秀。----By:xxx
          </p>
        </div>
      </div>
      <aside class="right">
