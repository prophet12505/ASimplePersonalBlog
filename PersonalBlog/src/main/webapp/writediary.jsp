    ...
    <div class="admin">
      <header>
        ...
        <nav class="topnav" id="topnav">
          ...
          >
          <a href="adminblog"
            ><span>Admin Blog</span><span class="en">管理博客</span></a
          >
          <a href="admindiary"
            ><span>Admin Diary</span><span class="en">管理日记</span></a
          >
          <a href="writeblog.jsp"
            ><span>Write Blog</span><span class="en">写博客</span></a
          >
          <a href="writediary.jsp"
            ><span>Write Diary</span><span class="en">写日记</span></a
          >
        </nav>
      </header>
    </div>
    <div class="box">
      <div class="admin">
        <form action="writediary">
          <h1 class="t_nav"><span>诉说你的喜怒哀乐。</span></h1>
          <br />
          <div id="layout">
            <header>
              <h1>写日记</h1>
            ...
            <input
              type="submit"
              value="uplode"
              style="background-color:#0055AA;color: white;font-size: 15px;
